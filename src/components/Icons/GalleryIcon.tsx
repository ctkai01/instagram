...
export interface IGalleryIconProps {
    className?: string;
    ariaLabel?: string;
    color?: 'white' | 'black';
...
const defaultProps: Partial<IGalleryIconProps> = {
    color: 'white'
}

export function GalleryIcon (props: IGalleryIconProps) {
