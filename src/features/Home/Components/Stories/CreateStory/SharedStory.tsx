...
export default function SharedStory(props: ISharedStoryProps) {
    const { loadingCreatedStory } = props;
            ...
            <Container baseUrl={window.location.origin}>
                <div className="header">
                    <div className="main-header">
                        {loadingCreatedStory ? 'Sharing' : 'Story shared'}
                    </div>
                </div>
                        ...
                        />
                            ...
                            <>
                                <img
                                    ...
                                    className=""
                                />
                                <div className="text">Your story has been shared.</div>
                            </>
                        )}
                    </div>
                </div>
