...
export function ActionReactPost(props: IActionReactPostProps) {
    ...
    const { post, isLike, handleChangeIsLike, handleFollowUserPost, activeShowDetailPost, loadingUnLikePost, loadingLikePost, fetchLikePost, fetchUnLikePost } = props;
                ...
                <div className="first-list">
                    <div className="item" onClick={() => {
                       ...
                       {(loadingUnLikePost || loadingLikePost) ? (
                            isLike ? <HeartIcon ariaLabel="Like" color="red" /> :  <>
