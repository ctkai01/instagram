...
export interface IDiscardPostProps {
...
export function DiscardPost(props: IDiscardPostProps) {
    const { isClickBackFirst, setFiles, setIsClickBackFirst, handleCloseModalDiscard, handleCloseModalCreatePost, setStep } = props;
